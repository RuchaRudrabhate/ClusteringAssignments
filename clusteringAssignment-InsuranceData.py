...
'''
This dataset is consist of 100 rows and 5 cols of the custmers 
that contains the information of insurance paid, age, days to renew
insurance claims made and income of the custmers
'''
...
ins_df = pd.read_csv('C:/2-dataset/Insurance Dataset.csv')
ins_df.describe()
ins_df.columns
