...
'''
This dataset is consist of 30 columns that consist of the information 
of customers of telecommunication company
'''

#Business objective
'''
Business objective is form clusters of the customers that 
contains the similar type of information
...
t_data = pd.read_excel('C:/2-dataset/Telco_customer_churn.xlsx')
t_data.describe()
t_data.columns
t_data.dtypes
'''
Customer ID                           object #ordinal
Count                                  int64 #quantitative
Quarter                               object #nominal
Referred a Friend                     object #nominal
Number of Referrals                    int64 #quantitave
Tenure in Months                       int64 #quantitave discrete
Offer                                 object #??
Phone Service                         object #nominal
Avg Monthly Long Distance Charges    float64 #quantitative
Multiple Lines                        object #qualitative nominal
Internet Service                      object #nominal
Internet Type                         object #nominal
Avg Monthly GB Download                int64 #quantitave discrete
Online Security                       object #nominal
Online Backup                         object #nominal
Device Protection Plan                object #nominal
Premium Tech Support                  object #nominal
Streaming TV                          object #nominal
Streaming Movies                      object #nominal
Streaming Music                       object #nominal
Unlimited Data                        object #nominal
Contract                              object #ordinal
Paperless Billing                     object #nominal
Payment Method                        object #ordinal
Monthly Charge                       float64 #quantitative discrete 
Total Charges                        float64 #quantitative discrete
Total Refunds                        float64 #quantitative discrete
Total Extra Data Charges               int64 #quantitative discrete
Total Long Distance Charges          float64 #quantitative discrete
Total Revenue                        float64 #quantitative discrete
dtype: object
'''
t_data.shape
# (7043, 30)
...
t_dataNew.to_csv("Telco_customer_churnNew.csv",encoding='utf-8')
...
df_normal.to_csv('C:/4-data mining/k_means_Telco_customer_churn.csv')
import os
os.getcwd()
